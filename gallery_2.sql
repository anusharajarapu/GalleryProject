...
INSERT INTO `additems` VALUES ('H2kI4d','vijayalakshmi','Buddy funy face');
...
INSERT INTO `album` VALUES ('Buddy','H2kI4d','vijayalakshmi');
...
CREATE TABLE `album_names` (
  ...
  CONSTRAINT `u_id` FOREIGN KEY (`added_by`) REFERENCES `register` (`name`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `album_names` VALUES ('Buddy','vijayalakshmi');
...
-- Dump completed on 2024-04-06 16:45:49
